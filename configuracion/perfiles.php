...
$ordenar_por=(isset($_GET['ordenar_por']) && $_GET['ordenar_por'] != '' ) ? $_GET['ordenar_por'] : 'perfil_id';
...
$sql = "SELECT * FROM perfiles ORDER BY $ordenar_por $ordenar_direccion"; 
if($debug==1)echo $sql;
$rs=pg_query($sql);
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper" class="distribuidores">
            <div class="container-fluid">
							...
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									<tr>
										...
										<th>ID<a href="perfiles.php?ordenar_por=perfil_id&ordenar_direccion=<?=$ordenar_direccion?>"class="sort-btn"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
										<th>Nombre<a href="perfiles.php?ordenar_por=nombre&ordenar_direccion=<?=$ordenar_direccion?>"class="sort-btn"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
										<th>Descripción<a href="perfiles.php?ordenar_por=descripcion&ordenar_direccion=<?=$ordenar_direccion?>"class="sort-btn"><i class="fa fa-sort" aria-hidden="true"></i></a></th>
										<th></th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="perfiles_editar.php?perfil_id=<?=$perfil['perfil_id']?>" title="Editar">Editar</a><span class="vertical-divider"> l </span>
											<a href="perfiles_eliminar.php?perfil_id=<?=$perfil['perfil_id']?>" title="Eliminar" onclick="areYouSure()">Eliminar</a>
										</td>
									</tr>
									<?
									}
                ...
                <div class="row">
					<div class="col-md-12">
						<h3 class="page-header">Agregar Perfil</h3>
					</div>
					<div class="col-md-6">
