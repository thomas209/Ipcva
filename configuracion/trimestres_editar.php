...
$sql="SELECT * from trimestres where trimestre_id=$trimestre_id";
$rs=pg_query($sql);
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper" class="distribuidores">
            <div class="container-fluid">
                <div class="row">
                   <div class="col-md-9">
                        <h1 class="page-header">Modificación del Trimestre</h1>
                    </div>
                    <div class="col-md-3 text-right">
						<a href="trimestres.php" class="btn btn-default btn-agregar"> Volver</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
				<form name="trimestremodificar" id="trimestremodificar" method="POST" action="trimestres_editar_pr.php" onsubmit="checkForm()">
	                ...
	                <div class="row no-mar">
						<div class="col-md-12">
							...
							<div class="form-group col-md-4">
								...
								<input type="radio" name="habilitado_carga" value="true" <?if($habilitado_carga=='t')echo 'checked'?>>Si  
								<input type="radio" name="habilitado_carga" value="false" <?if($habilitado_carga=='f')echo 'checked'?>>No
							</div>
						</div>
					</div>
					<div class="row no-mar">
