...
$sql="SELECT * from perfiles where perfil_id=$perfil_id";
$rs=pg_query($sql);
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper" class="distribuidores">
            <div class="container-fluid">
                <div class="row">
                   <div class="col-md-9">
                        <h1 class="page-header">Modificación del Perfil</h1>
                    </div>
                    <div class="col-md-3 text-right">
						<a href="perfiles.php" class="btn btn-default btn-agregar"> Volver</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
				<form name="perfilnmodificar" id="perfilmodificar" method="POST" action="perfiles_editar_pr.php" onsubmit="checkForm()">
