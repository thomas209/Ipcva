...
$sql="SELECT detalle_trimestre_id, trimestre_id, usuario_id, centro_costos_id, porcentaje FROM detalles_trimestres";
$rs=pg_query($sql);
$detalles_trimestres=pg_fetch_all($rs);
pg_free_result($rs);

$sql="SELECT usuario_id, nombre, apellido FROM usuarios WHERE perfil_id=5 and habilitado=true order by apellido";
$rs=pg_query($sql);
...
$sql="SELECT trimestre_id, nombre FROM trimestres WHERE habilitado_carga=true";
$rs=pg_query($sql);
	...
	<div id="wrapper">
        ...
        <div id="page-wrapper" class="distribuidores">
            <div class="container-fluid">
              ...
              <form name="altatrimestre" id="altatrimestre" method="POST" action="detalle_trimestre_alta_pr.php" onsubmit="checkForm()">
						...
						<div class="form-group col-md-6">
							...
							<select class="form-control" name="usuario_id" id="usuario_id">
								...
								foreach ($empleados as $empleado) {
									echo "<option value=\"{$empleado['usuario_id']}\">{$empleado['nombre']} {$empleado['apellido']}</option>";
								}
								?>
							</select>
						</div>
